        ...
        <div class="container section-spacing">
            ...
            <div class="row">
                <div v-for="(element, index) in services" :key="index" class="card col">
                    <div v-html="element.image" class="card-icons"></div>
...
export default {
  ...
  data() {
      return {
          services: [
              {
                  image: `<svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google" class="svg-inline--fa fa-google " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512">
              ...
              {
                  image: `<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="gear" class="svg-inline--fa fa-gear " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              ...
              {
                  image: `<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="building" class="svg-inline--fa fa-building " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
              ...
              {
                  image: `<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chart-column" class="svg-inline--fa fa-chart-column " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
