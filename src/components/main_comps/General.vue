<template>
    <div class="section-gray">
        <div class="container section-spacing">
            ...
            <div class="row">
                <div class="card col">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="road" class="svg-inline--fa fa-road card-icons" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                    ...
                    <span> Lorem ipsum, dolor sit amet consectetur adipisicing elit. Fuga similique facilis consequatur beatae magni esse suscipit </span>
                </div>
                <div class="card col">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="video" class="svg-inline--fa fa-video card-icons" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                ...
                <div class="card col">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="building" class="svg-inline--fa fa-building card-icons" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
